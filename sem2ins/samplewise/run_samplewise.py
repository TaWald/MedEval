...
from sem2ins.samplewise.samplewise_evaluation import calculate_samplewise_results, get_samplewise_statistics
from sem2ins.utils.configuration import DataPair
import pandas as pd
from batchgenerators.utilities import file_and_folder_operations as ff

def run_samplewise(data_pair: DataPair, n_processes: int = 1):
