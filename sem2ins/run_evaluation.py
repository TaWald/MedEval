import os
from sem2ins.evaluations.hard_evaluation import hard_evaluate
from sem2ins.samplewise.run_samplewise import run_samplewise

from sem2ins.utils.parser import get_samplewise_eval_parser
from sem2ins.utils.loading import get_matching_gt_and_preds_from_data_pair


import sem2ins.utils.configuration as configuration
from sem2ins.instancewise.connected_components import run_connected_components
from sem2ins.instancewise.match_segmentations import run_tp_fp_calculation
from sem2ins.instancewise.resample import run_resample


def evaluate_configuration(
    data_pair: configuration.DataPair,
    gt_kernel: str = "ball",
    gt_dilation: int = 3,
    pd_kernel: str = "ball",
    pd_dilation: int = 3,
