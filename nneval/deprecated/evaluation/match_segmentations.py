...
from nneval.utils.default_values import get_empty_prediction, get_empty_groundtruth, get_empty_strict
from nneval.utils.io import get_all_sample_names, get_spacing_from_image
from nneval.utils.io import get_flat_array_from_image
...
def run_tp_fp_calculation(
    ...
    config_strings: str,
    n_processes: int,
    data_pair: conf.DatasetEvalInfo,
):
